...
training_set = train_datagen.flow_from_directory('/content/drive/My Drive/Brain Tumor CNN/Brain-Tumor-Images-Dataset/training_set',
                                                 target_size = (64, 64), # make sure to change target_size if you altered input_shape above
                                                 batch_size = 32,
                                                 class_mode = 'binary')
test_set = test_datagen.flow_from_directory('/content/drive/My Drive/Brain Tumor CNN/Brain-Tumor-Images-Dataset/test_set',
                                            target_size = (64, 64),
                                            batch_size = 32,
                                            class_mode = 'binary')
...
if score[1] == 0:
  print('The convolutional neural network predicts that that this image doesn't show signs of hemorrhage.')
else:
